              ...
              <div key={enr.enrollment_id} className="p-4 bg-white hover:bg-blue-50 hover:shadow-md transition-colors space-y-4">
                ...
                <div className="flex items-center gap-2 pt-1.5">
                  <button
                    onClick={() => handleGenerateReceipt(enr)}
                    disabled={busy}
                    className="flex-1 py-2.5 rounded-xl bg-slate-100 text-slate-700 font-bold hover:bg-slate-200 transition-all active:scale-95 shadow-sm border border-slate-200 text-xs sm:text-sm disabled:opacity-50"
                  >
                    Receipt
                  </button>
                  <button
